...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(Stream.iter(1)(_ + 1).takeWhile(_ <= 10).toList)
    println(Stream.iter(1)(_ + 1).map(_ - 1).takeWhile(_ <= 10).toList)
    println((Stream(1,2,3,4).zipWith(Stream("a", "b"))((a, b) => (a, b))).toList)
    println(Stream(1,2,3).zipAll(Stream("a", "b")).toList)
